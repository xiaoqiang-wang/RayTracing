...
g++ -O3 -fopenmp smallpt.cpp -o smallpt_1 -std=c++17 
#g++ -O3 -fopenmp smallpt.cpp -o smallpt_1 -std=c++11 -ggdb
#g++ -O0  smallpt.cpp -o smallpt_1 -std=c++11 -ggdb
